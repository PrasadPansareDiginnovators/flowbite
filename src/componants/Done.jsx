...
const Done = () => {
  ...
  return (
    <div className="w-[450px] flex-shrink-0 p-2 dark:bg-gray-900">
      <h2 className="text-lg font-semibold mb-4 text-gray-800 dark:text-gray-200">Done</h2>
      <div className="space-y-4">
        ...
        <div className="w-[435px] h-10 flex-shrink-0 dark:bg-gray-700 rounded-lg shadow flex justify-center items-center cursor-pointer border-2 border-dotted dark:border-gray-600 border-gray-400 mt-4">
